...
export default function WeatherCustom() {
  ...
  const [weatherData, setWeatherData] = useState({
    temp: null,
    city_name: null,
    weather: { description: null, icon: null, iconUrl: null },
  })
      ...
      <div className="">
        {isLoading && <div className="flex w-fit bg-base-200 rounded-3xl px-2 py-2 my-1 shadow border-solid border-2 border-base-content">
          ...
          <div className=" w-[5rem] flex justify-center items-center">
            <div role="status">
              <svg aria-hidden="true" className="mr-2 w-8 h-8 text-gray-200 animate-spin dark:text-gray-600 fill-accent" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        {!isLoading &&
          <div className="flex w-[250px] bg-base-200 rounded-3xl px-2 py-2  shadow-lg shadow-base-content/10">
            ...
            <div className=" w-[40%] flex justify-center items-center">
              <img alt="icon" className=" w-[4rem]" src={weatherData.weather.iconUrl} />
            </div>
          </div>
        }
      </div>
