// Uses google services: places-backend.googleapis.com directions-backend.googleapis.com
// disable adblockers
...
export default function Maps() {
  ...
  return (
    <div className='flex flex-col justify-between w-fit figma-bookmark-container px-5 py-5'>
      <h1 className='text-2xl justify-center font-bold figma-bookmark-label text-center'>Map</h1>
      <div>
          <Autocomplete>
        ...
        <div className='flex'>
          ...
          <span className="text-slate-200 mr-2 font-bold">{distance}</span>
          <span className="text-slate-200 mr-2 font-bold">{duration}</span>
        </div>
      </div>
