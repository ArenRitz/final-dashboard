      ...
      <div className=" absolute top-1/4 left-1/4 bg-slate-100/95 w-1/2 rounded-3xl flex flex-row">
        <div className="w-1/4 h-full ">
          <div className="navbar bg-neutral text-neutral-content">
            <button className="btn btn-ghost normal-case text-xl" onClick={handleClick} name="bookmarks">Bookmarks</button>
          </div>
          <div className="navbar bg-neutral">
            <a className="btn btn-ghost normal-case text-xl " onClick={handleClick} name="twitch">Twitch</a>
          </div>
          <div className="navbar bg-neutral text-primary-content">
            <a className="btn btn-ghost normal-case text-xl" onClick={handleClick} name="weather">Weather</a>
          </div>
          <div className="navbar bg-neutral text-neutral-content">
            <a className="btn btn-ghost normal-case text-xl" onClick={handleClick} name="clock">Clock</a>
          </div>
          <div className="navbar bg-neutral text-neutral-content">
            <a className="btn btn-ghost normal-case text-xl" onClick={handleClick} name="spotify">Spotify</a>
          </div>
          <div className="navbar bg-neutral text-neutral-content">
            <a className="btn btn-ghost normal-case text-xl" onClick={handleClick} name="recipe">Recipe</a>
          </div>
          <div className="navbar bg-neutral text-neutral-content">
            <a className="btn btn-ghost normal-case text-xl" onClick={handleClick} name="aztro">Aztro</a>
          </div>
        </div>
